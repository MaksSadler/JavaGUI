package lesson_2.draw_pic.view;


import lesson_2.circles.exceptions.BallsOverflowException;
import lesson_2.circles.sprites.Background;
import lesson_2.common.CanvasRepaintListener;
import lesson_2.common.Interactable;
import lesson_2.common.MainCanvas;
import lesson_2.draw_pic.sprites.Picture;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    public MainWindow(){
        ...
        addMouseListener(new lesson_2.draw_pic.view.MouseListener(this));
